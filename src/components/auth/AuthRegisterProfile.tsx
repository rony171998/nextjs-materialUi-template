...
export const AuthRegisterProfile = ({ ...others }) => {
        ...
        {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
          <form noValidate onSubmit={handleSubmit} {...others}>
            <Grid container spacing={1}>
              <Grid item xs={12}>
                <FormControl fullWidth error={Boolean(touched.profileImg && errors.profileImg)}>
                  <MuiFileInputStyled
                    fullWidth
                    size="medium"
                    variant="outlined"
                  ...
                  {touched.profileImg && errors.profileImg && (
                    <FormHelperText error>{errors.profileImg}</FormHelperText>
                  )}
                </FormControl>
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <Autocomplete
                  ...
                  //   if (newValue)
                  //     setValue(field, newValue?.code);
                  // }}
                  //value={countries.find((item) => item.label === dialogValue.paisdestino)}
                  getOptionLabel={(option: CountryType) => option.label ? option.code + ' - ' + option.label : option}
                  freeSolo
                />
              </Grid>
              <Grid item xs={12} sm={6}>
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <MuiTelInput
                      ...
                      fullWidth
                      defaultCountry={"CO"}
                      helperText={fieldState.invalid ? "telefono is invalid" : ""}
